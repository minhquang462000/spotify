...
export default function CardRadioHome(props: ICardRadioHomeProps) {
    return (
        <div className="flex flex-col max-w-[200px] cursor-pointer  group rounded-md  p-3  hover:bg-gradient-to-t from-[#1a1a1a] to-transparent gap-2">
            ...
            <p className="font-bold text-start mt-1 w-full overflow-hidden truncate ">Sơn Tùng Mtp Radio</p>
            <p className="text-[#818181] text-sm text-wrap font-bold line-clamp-2">Với MONO,Đen,Hiếu Thứ Hai và nhiều hơn 1 nghệ sĩ nữa</p>
        </div>
    );
}
