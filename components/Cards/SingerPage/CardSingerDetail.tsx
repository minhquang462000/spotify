...
export default function CardSingerDetail(props: ICardSingerDetailProps) {
  ...
  return (
    <section
      ...
      className="w-1/2 fixed z-[998]  overflow-y-scroll max-h-[70vh] body-childHome rounded-lg  overflow-hidden "
    >
      <div className="w-full h-[400px] relative overflow-hidden bg-[#000000]">
        <img
        ...
        <button
          ...
          className="absolute top-4 w-7 h-7 text-gray-400 hover:text-white flex justify-center items-center rounded-full hover:bg-[#333] bg-opacity-30 right-4"
        >
          <IoMdClose size={22} />
        </button>
      </div>
